...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $purchase_permission = Permission::where('slug', 'products-all')->first();
        ...
        $purchase_role = new Role();
        $purchase_role->slug = 'purchase';
        $purchase_role->name = 'Purchase role';
        $purchase_role->save();
        $purchase_role->permissions()->attach($purchase_permission);
        ...
        $purchase_role = Role::where('slug', 'purchase')->first();
        ...
        $products_all->save();
        $products_all->roles()->attach($purchase_role);
        ...
        $purchase_perm = Permission::where('slug','products-all')->first();
        ...
        $purchase = new User();
        $purchase->name = 'Purchase user';
        $purchase->email = 'purchase@mail.org';
        $purchase->password = bcrypt('123456');
        $purchase->save();
        $purchase->roles()->attach($purchase_role);
        $purchase->permissions()->attach($purchase_perm); // prooducts
